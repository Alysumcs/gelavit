...
T["sk"] = {
    ...
    "hero_for": "Pre",
    "meta_home": "Gelavit Pure® — až 97 % hydrolyzovaného rybieho kolagénu s vitamínom C. Bez éčiek a konzervantov, vyvinuté na Slovensku. Doprava zdarma nad 50 €.",
    "meta_404": "Stránka sa nenašla. Prejdite na úvod alebo si prezrite našu radu kolagénových produktov.",
...
T["en"] = {
    ...
    "hero_for": "For",
    "meta_home": "Gelavit Pure® — up to 97 % hydrolysed fish collagen with vitamin C. No E numbers, no preservatives, developed in Slovakia. Free shipping over €50.",
    "meta_404": "Page not found. Go back to the homepage or browse our range of collagen products.",
...
T["de"] = {
    ...
    "hero_for": "Für",
    "meta_home": "Gelavit Pure® — bis zu 97 % hydrolysiertes Fischkollagen mit Vitamin C. Ohne E-Nummern und Konservierungsmittel, aus der Slowakei. Versand ab 50 € gratis.",
    "meta_404": "Seite nicht gefunden. Zurück zur Startseite oder stöbern Sie in unserem Kollagen-Sortiment.",
